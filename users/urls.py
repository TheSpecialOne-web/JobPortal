...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            ...
            extra_context={
                "message": "Password reset link has been sent to your email.Please create a new password through the link."
            },
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name="users/newpassword.html",
            extra_context={
                "message": "  Your password has been changed successfully. Please "
            },
        ),
